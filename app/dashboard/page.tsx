                            ...
                            <Draggable key={quiz._id} draggableId={quiz._id} index={index}>
                              {(provided, snapshot) => (
                                ...
                                >
                                  ...
                                  {/* Action buttons */}
                                  <div className="flex items-center justify-start sm:justify-end gap-1 sm:gap-0 shrink-0 border-t-[3px] sm:border-t-0 sm:border-l-[3px] border-foreground/10 pt-2 sm:pt-0 sm:pl-2 ml-9 sm:ml-1 w-full sm:w-auto">
                                    <Link
                                    ...
                                    >
                                      {copiedId === quiz.slug
                                        ? <span className="chaos-heading text-[9px] text-primary">COPIED</span>
                                        : <Copy size={15} />
                                      }
                                    </button>
